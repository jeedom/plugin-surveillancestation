  ...
  <div class="col-lg-2 col-md-3 col-sm-4">
    <div class="bs-sidebar">
      <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
        <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un surveillancestation}}</a>
   ...
   <form class="form-horizontal">
    <fieldset>
     ...
     <div class="form-group">
       ...
       <div class="col-sm-1">
        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="ip" style="font-size : 1em"></span>
      </div>
      ...
      <label class="col-sm-1 control-label">{{Fabricant}}</label>
      <div class="col-sm-1">
        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="vendor" style="font-size : 1em"></span>
      </div>
      <label class="col-sm-1 control-label">{{Modele}}</label>
      <div class="col-sm-1">
...
<div role="tabpanel" class="tab-pane" id="commandtab"><br/>
  ...
  <table id="table_cmd" class="table table-bordered table-condensed">
    <thead>
      <tr>
        <th>#</th><th>{{Nom}}</th><th>{{Type}}</th><th>{{Options}}</th><th>{{Action}}</th>
      </tr>
    </thead>
    <tbody>
    </tbody>
